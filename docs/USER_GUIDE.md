...
5. Explore the **Analysis & Coach** tab for commentary and export options.
6. Visit **Experiments** to run automated matches and review CSV outputs.
7. Save and load sessions from the File shortcuts.
